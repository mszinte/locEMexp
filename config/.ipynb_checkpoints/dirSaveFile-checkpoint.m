...
const.task_amp_sequence_file    =   sprintf('data/%s/%s/add/%s_%s_task-%s%s_ampSequence_matFile.mat',const.sjct,const.session,const.sjct,const.session,const.cond2_txt,const.cond1_txt);
