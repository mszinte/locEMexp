...
for run in runs:
    ...
    for sequence in sequences:
        ...
        # make figure folder
        try: os.makedirs('{file_dir}/add/figures/{task_txt}/run-{run_txt}/seq-{sequence_txt}/'.format(
                                file_dir = file_dir, task_txt = task, run_txt = run_txt, sequence_txt = sequence_txt))
        except: pass
        ...
        for trial in trials:
            ...
            ax1,ax2,ax3,tmp = draw_bg_trial(analysis_info)
            # plot whole trial
